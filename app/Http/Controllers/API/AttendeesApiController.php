...
class AttendeesApiController extends ApiBaseController
{
    ...
    public function showattendeesevent(Request $request){
        ...
        $attendees = Attendee::select('attendees.id','attendees.event_id','attendees.first_name','attendees.last_name',
                    'attendees.email', 'attendees.private_reference_number', 'attendees.has_arrived',
                    'attendees.phone_number', 'attendees.school', 'orders.order_reference')
